<?php
    $mysqli = new mysqli("localhost","root", "root","fabank");
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            while($cliente = $clientes -> fetch_assoc()){
                                                $url_api = 'https://randomuser.me/api/?inc=picture';
                                                $json = file_get_contents($url_api);
                                                $data = json_decode($json, true);
                                                $foto = $data["results"][0]["picture"]["thumbnail"];                                            
                                                echo "<tr>";
                                                echo "<td><img class='rounded-circle me-2' width='30' height='30' src='".$foto."'>". $cliente["nome"] . "</td>";
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © Banco Sweet 2023</span></div>
                </div>
            </footer>
